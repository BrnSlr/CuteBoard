...
#include "ui_gauge_vertical_editor.h"
#include "ui/widgets/utils/icon_factory.h"

GaugeVerticalEditor::GaugeVerticalEditor(GaugeVertical *display, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::GaugeVerticalEditor),
    mGauge(display)
{
    ui->setupUi(this);
    ...
    connect(ui->buttonBox->button(QDialogButtonBox::Apply), &QPushButton::clicked,
            this, &GaugeVerticalEditor::updateElement);
...
GaugeVerticalEditor::~GaugeVerticalEditor()
{
    delete ui;
}
...
void GaugeVerticalEditor::updateElement()
{
    if(mGauge) {
        ...
        mGauge->setGaugeVPosition(GaugeVertical::GaugeVPosition(ui->positionComboBox->currentIndex()));

        mGauge->setAxisScale(GaugeVertical::AxisScale(ui->rangeComboBox->currentIndex()));
